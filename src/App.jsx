...
const ServiceAdmin = lazyRetry(() => import('./pages/ServiceAdmin'), 'service-admin')
      ...
      <main style={{ flex: 1, padding: 'var(--space-lg)', background: 'var(--color-bg-base)' }}>
          <Suspense fallback={<RouteLoader />}>
            <Routes>
              ...
              <Route path="/staff-profile/:email" element={<PermissionGate permKey="staff"><PeopleStaffProfile /></PermissionGate>} />
              ...
              <Route path="/service-admin"   element={<PermissionGate permKey="service_admin"><ServiceAdmin /></PermissionGate>} />

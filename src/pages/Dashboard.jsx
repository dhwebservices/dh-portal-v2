...
export default function Dashboard() {
  ...
  return (
    <div className="fade-in">
      ...
      <div style={{ marginBottom: dashboardDensity === 'compact' ? 'var(--space-lg)' : 'var(--space-xl)' }}>
        <div style={{
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'minmax(0,1.05fr) minmax(320px,0.95fr)', gap: 'var(--space-xl)' }}>
            <div>
              <div style={{ display:'flex', alignItems:'center', gap: 'var(--space-md)', minWidth:0, marginBottom: 'var(--space-lg)' }}>
                <div style={{
                  width: 68,
                  height: 68,
                  borderRadius: 'var(--border-radius-lg)',
                  ...
                  {firstName[0]?.toUpperCase() || <UserRound size={28} />}
                </div>
              ...
              <div style={{ marginTop: 'var(--space-md)' }}>
                <div style={{
                  ...
                  {workspaceDashboardMeta.toolbarNote}
                </div>
            ...
            <div>
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  {workspaceDashboardMeta.teamTitle}
                </div>
                <div style={{
                  display: 'flex',
                  gap: '6px',

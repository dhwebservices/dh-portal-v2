...
export const QUICK_ACTION_OPTIONS = [
  ...
  ['my_department', 'My Department', '/my-department'],
  ['schedule', 'Schedule', '/schedule'],
  ['appointments', 'Appointments', '/appointments'],
  ['clients', 'Clients', '/clients'],
  ['client_pipeline', 'Client Pipeline', '/client-pipeline'],
  ['support', 'Support', '/support'],
  ['knowledge_base', 'Knowledge Base', '/knowledge-base'],
  ['workflow_automation', 'Workflow Automation', '/workflow-automation'],
  ['compliance_rules', 'Compliance Rules', '/hr/compliance-rules'],
  ['training_catalogue', 'Training Catalogue', '/hr/training-catalogue'],
...
export const DEFAULT_PORTAL_PREFERENCES = {
  ...
  quickActions: ['mytasks', 'notifications', 'clients', 'support'],
...
const PRESET_PAYLOADS = {
  outreach: {
    ...
    showSystemBanners: true,
    navDensity: 'compact',
    quickActions: ['mytasks', 'notifications', 'clients', 'client_pipeline', 'support', 'knowledge_base'],
  ...
  manager: {
    ...
    showSystemBanners: true,
    navDensity: 'comfortable',
    quickActions: ['dashboard', 'my_department', 'mytasks', 'notifications', 'client_pipeline', 'workflow_automation'],
  ...
  hr_admin: {
    ...
    showSystemBanners: true,
    navDensity: 'comfortable',
    quickActions: ['dashboard', 'notifications', 'reports', 'workflow_automation', 'compliance_rules', 'training_catalogue'],

...
const PRESET_PAYLOADS = {
  ...
  manager: {
    ...
    showSystemBanners: true,
    navDensity: 'comfortable',
    quickActions: ['dashboard', 'my_department', 'mytasks', 'notifications', 'client_pipeline', 'support'],
  ...
  hr_admin: {
    ...
    showSystemBanners: true,
    navDensity: 'comfortable',
    quickActions: ['dashboard', 'notifications', 'reports', 'compliance_rules', 'training_catalogue', 'clients'],

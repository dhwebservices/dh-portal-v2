-- ============================================================================
-- DH Website Builder - Database Schema (Simplified)
-- Version: 1.0
-- Created: 2026-08-03
-- RLS policies simplified - all authenticated users have access
-- ============================================================================
...
create policy "website_pages_all" on website_pages for all using (auth.uid() is not null);
...
create policy "website_versions_all" on website_versions for all using (auth.uid() is not null);
...
create policy "website_assets_all" on website_assets for all using (auth.uid() is not null);
...
create policy "website_components_all" on website_components for all using (auth.uid() is not null);
...
create policy "website_settings_select" on website_settings for select using (true);
create policy "website_settings_update" on website_settings for update using (auth.uid() is not null);
...
create policy "website_change_log_all" on website_change_log for all using (auth.uid() is not null);
